...
<body>
			...
			<form
				...
				method="post" action="${ctx}/user/addUser.do"
						...
						<table class="form" width="280">
							<tbody>
								...
								<tr>
									<th><label class="form-field">登陆名</label></th>									
                                     <td colspan="3"><input type="text" id="innerUserCode" name="account"
								...
								<tr>
                                   <th><label for="password" class="form-field">密码</label></th>
								    <td colspan="3">
								        <input type="password" id="password" name="pwd" value="" class="required alphanumeric" minlength="6" maxlength="15" 
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="text" id="phoneNo" name="phone" ></td>
								</tr>
